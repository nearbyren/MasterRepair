...
import apps.master.repair.databinding.ActivityAboutUsBinding
...
class AboutUsActivity : BaseAppBindActivity<ActivityAboutUsBinding>() {
    ...
    override fun initBarHelperConfig(): BarHelperConfig {
        return BarHelperConfig.builder().setBack(true).setIconLeft(R.drawable.icon_white_left)
            .setBgColor(R.color.toolbar_bg_color).setTitle(title = getString(R.string.info_13), titleColor = nearby.lib.base.R.color.white).build()
    }
