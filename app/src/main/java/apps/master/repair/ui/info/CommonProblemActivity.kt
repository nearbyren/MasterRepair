...
import apps.master.repair.databinding.ActivityCommonProblemBinding
import apps.master.repair.model.ProblemDto
...
class CommonProblemActivity : BaseAppBindActivity<ActivityCommonProblemBinding>() {
    ...
    private val itemProblemAdapter by lazy { apps.master.repair.adapter.ItemProblemAdapter() }
